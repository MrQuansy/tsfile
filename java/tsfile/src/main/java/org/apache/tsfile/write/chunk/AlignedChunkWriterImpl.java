...
public class AlignedChunkWriterImpl implements IChunkWriter {
  ...
  public void write(long time, PoolBinary value, boolean isNull) {
    valueChunkWriterList.get(valueIndex++).write(time, value, isNull);
  }
  ...
  public void write(long time, PoolBinary value, boolean isNull, int valueIndex) {
    valueChunkWriterList.get(valueIndex).write(time, value, isNull);
  }
      ...
      switch (writer.getDataType()) {
        ...
        case STRING:
          writer.write(
              ...
              point != null
                  ? point.getBinary()
                  : new PoolBinary("".getBytes(StandardCharsets.UTF_8)),
              point == null);
          break;
      }
    }
  ...
  public void writeByColumn(long time, PoolBinary value, boolean isNull) {
    valueChunkWriterList.get(valueIndex).write(time, value, isNull);
  }
