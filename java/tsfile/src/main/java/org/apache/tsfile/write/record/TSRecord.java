...
public class TSRecord {
  ...
  public TSRecord addPoint(String measurementName, String val) {
    return addTuple(
        new StringDataPoint(measurementName, new PoolBinary(val, TSFileConfig.STRING_CHARSET)));
  }

  @TsFileApi
  public TSRecord addPoint(String measurementName, byte[] val) {
    return addTuple(new StringDataPoint(measurementName, new PoolBinary(val)));
  }
