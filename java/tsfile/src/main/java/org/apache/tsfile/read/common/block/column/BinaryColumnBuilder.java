...
public class BinaryColumnBuilder implements ColumnBuilder {
  ...
  public static final BinaryColumn NULL_VALUE_BLOCK =
      new BinaryColumn(0, 1, new boolean[] {true}, new PoolBinary[1]);
  ...
  private PoolBinary[] values = new PoolBinary[0];
  ...
  @Override
  public ColumnBuilder writeBinary(PoolBinary value) {
