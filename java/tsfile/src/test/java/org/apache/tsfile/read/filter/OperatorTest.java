  ...
  public void testGt() {
    ...
    Filter binaryFilter =
        ValueFilterApi.gt(
            ...
            new PoolBinary("test1", TSFileConfig.STRING_CHARSET),
            TSDataType.TEXT);
    Assert.assertTrue(
        binaryFilter.satisfyBinary(
            TESTED_TIMESTAMP, new PoolBinary("test2", TSFileConfig.STRING_CHARSET)));
    Assert.assertFalse(
        binaryFilter.satisfyBinary(
            TESTED_TIMESTAMP, new PoolBinary("test0", TSFileConfig.STRING_CHARSET)));
  }
