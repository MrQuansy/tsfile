...
public class StringStatisticsTest {
  ...
  public void testUpdate() {
    Statistics<PoolBinary> binaryStats = new BinaryStatistics();
    binaryStats.updateStats(new PoolBinary("aaa", TSFileConfig.STRING_CHARSET));
    assertFalse(binaryStats.isEmpty());
    binaryStats.updateStats(new PoolBinary("bbb", TSFileConfig.STRING_CHARSET));
    assertFalse(binaryStats.isEmpty());
  ...
  public void testMerge() {
    Statistics<PoolBinary> stringStats1 = new BinaryStatistics();
    stringStats1.setStartTime(0);
    stringStats1.setEndTime(2);
    Statistics<PoolBinary> stringStats2 = new BinaryStatistics();
    stringStats2.setStartTime(3);
    stringStats2.setEndTime(5);

    stringStats1.updateStats(new PoolBinary("aaa", TSFileConfig.STRING_CHARSET));
    stringStats1.updateStats(new PoolBinary("ccc", TSFileConfig.STRING_CHARSET));

    stringStats2.updateStats(new PoolBinary("ddd", TSFileConfig.STRING_CHARSET));

    Statistics<PoolBinary> stringStats3 = new BinaryStatistics();
    ...
    Statistics<PoolBinary> stringStats4 = new BinaryStatistics();
    stringStats4.setStartTime(0);
    stringStats4.setEndTime(5);
    Statistics<PoolBinary> stringStats5 = new BinaryStatistics();
    stringStats5.setStartTime(1);
    stringStats5.setEndTime(4);

    stringStats4.updateStats(new PoolBinary("eee", TSFileConfig.STRING_CHARSET));
    stringStats4.updateStats(new PoolBinary("fff", TSFileConfig.STRING_CHARSET));

    stringStats5.updateStats(new PoolBinary("ggg", TSFileConfig.STRING_CHARSET));
