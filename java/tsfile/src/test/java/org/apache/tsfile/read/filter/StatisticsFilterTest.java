...
public class StatisticsFilterTest {
  ...
  public void before() {
    ...
    statistic4.update(100L, new PoolBinary("a", STRING_CHARSET));
    statistic4.update(200L, new PoolBinary("a", STRING_CHARSET));

    StringStatistics statistic5 = new StringStatistics();
    statistic5.update(100L, new PoolBinary("b", STRING_CHARSET));
    statistic5.update(200L, new PoolBinary("b", STRING_CHARSET));

    StringStatistics statistic6 = new StringStatistics();
    statistic6.update(100L, new PoolBinary("a", STRING_CHARSET));
    statistic6.update(200L, new PoolBinary("b", STRING_CHARSET));
  ...
  public void testEq() {
    ...
    Filter stringEq =
        ValueFilterApi.eq(
            DEFAULT_MEASUREMENT_INDEX, new PoolBinary("a", STRING_CHARSET), TSDataType.STRING);
  ...
  public void testLt() {
    ...
    Filter stringLt =
        ValueFilterApi.lt(
            DEFAULT_MEASUREMENT_INDEX, new PoolBinary("b", STRING_CHARSET), TSDataType.STRING);
  ...
  public void testBetweenAnd() {
    ...
    Filter stringBetweenAnd =
        ValueFilterApi.between(
            ...
            new PoolBinary("b", STRING_CHARSET),
            TSDataType.STRING);
