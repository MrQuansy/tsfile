...
public class FilterSerializeTest {
  ...
  public void testBinaryFilter() throws IOException {
    Filter[] filters =
        new Filter[] {
          ValueFilterApi.gt(
              DEFAULT_MEASUREMENT_INDEX, new PoolBinary("test", STRING_CHARSET), TSDataType.TEXT),
          ValueFilterApi.gtEq(
              DEFAULT_MEASUREMENT_INDEX, new PoolBinary("test", STRING_CHARSET), TSDataType.TEXT),
          ValueFilterApi.lt(
              DEFAULT_MEASUREMENT_INDEX, new PoolBinary("test", STRING_CHARSET), TSDataType.TEXT),
          ...
          ValueFilterApi.between(
              DEFAULT_MEASUREMENT_INDEX,
              new PoolBinary("test", STRING_CHARSET),
              new PoolBinary("string", STRING_CHARSET),
              TSDataType.TEXT),
  ...
  public void testStringFilter() throws IOException {
    Filter[] filters =
        new Filter[] {
          ValueFilterApi.gt(
              DEFAULT_MEASUREMENT_INDEX, new PoolBinary("test", STRING_CHARSET), TSDataType.STRING),
          ValueFilterApi.gtEq(
              DEFAULT_MEASUREMENT_INDEX, new PoolBinary("test", STRING_CHARSET), TSDataType.STRING),
          ValueFilterApi.lt(
              DEFAULT_MEASUREMENT_INDEX, new PoolBinary("test", STRING_CHARSET), TSDataType.STRING),
